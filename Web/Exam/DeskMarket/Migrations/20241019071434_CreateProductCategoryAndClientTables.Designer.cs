...
namespace DeskMarket.Migrations
{
    ...
    [Migration("20241019071434_CreateProductCategoryAndClientTables")]
    partial class CreateProductCategoryAndClientTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeskMarket.Data.Models.Product", b =>
                {
                    ...
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasComment("Category identifier for the product.");

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasComment("Description of the current product.");

                    b.Property<string>("ImageUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)")
                        .HasComment("URL of the product's image.");

                    b.Property<bool>("IsDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasComment("Flag indicating if the product is deleted.");
                    ...
                    b.Property<string>("SellerId")
                        ...
                        .HasComment("Identifier of the seller of the product.");
            ...
            modelBuilder.Entity("DeskMarket.Data.Models.ProductClient", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int")
                        .HasComment("Primary key and foreign key linking to the product.");

                    b.Property<string>("ClientId")
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Primary key and foreign key linking to the client.");
